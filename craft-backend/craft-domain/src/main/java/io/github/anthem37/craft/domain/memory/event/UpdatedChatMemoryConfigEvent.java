 ...
 */
@Data
public class UpdatedChatMemoryConfigEvent implements IDomainEvent<Long> {

    /**
     * 事件类型，标识事件的名称
     */
    public final String eventType = "UpdatedChatMemoryConfigEvent";
    ...
    public UpdatedChatMemoryConfigEvent(ChatMemoryConfig chatMemoryConfig) {
