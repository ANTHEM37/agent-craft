 ...
 */
@Data
public class UpdatedLLMConfigEvent implements IDomainEvent<Long> {

    /**
     * 事件类型，标识事件的名称
     */
    public final String eventType = "UpdatedLLMConfigEvent";
    ...
    public UpdatedLLMConfigEvent(LLMConfig llmConfig) {
